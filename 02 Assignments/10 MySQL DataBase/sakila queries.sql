...
-- 6b. Use JOIN to display the total amount run up by each staff member in August of 2005. Use tables staff and payment.
...
-- FROM country c
-- JOIN customer cm
-- ON c.country_id = cm.customer_id
...
-- JOIN country cnr
-- ON ct.country_id = cnr.country_id;
