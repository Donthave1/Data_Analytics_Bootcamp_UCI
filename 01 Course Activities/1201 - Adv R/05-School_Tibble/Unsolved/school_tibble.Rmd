...
district.summary.tb <- 
  frame_data(
    ...
    school_count, student_count, total_budget, mean_math_score, mean_reading_score, percentage_passing_math, percentage_passing_reading, overall_passing_rate
  )
```
